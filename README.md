...
**Ошибки:**
- `400` - `nominant_id` или `category_id` не указаны
- `400` - номинант не участвует в указанной категории
- `404` - номинант или категория не найдены
- `409` - пользователь уже голосовал в этой категории
...
### Таблицы:
- `categories` - категории (номинации)
- `nominants` - номинанты
- `nominant_categories` - связь many-to-many между номинантами и категориями (один номинант может участвовать в нескольких категориях)
- `users` - пользователи Telegram
- `votes` - голоса (с уникальным ограничением на tg_user_id + category_id)

### Структура голосования:
- Пользователь может проголосовать только один раз в каждой категории
- Один номинант может участвовать в нескольких категориях
- При голосовании необходимо указать и `nominant_id`, и `category_id`
- Система проверяет, что номинант действительно участвует в указанной категории
